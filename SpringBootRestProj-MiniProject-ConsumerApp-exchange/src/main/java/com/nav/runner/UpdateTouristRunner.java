...
//		template.put(serviceUrl, entity);
		...
		//using PUT() method
		ResponseEntity<String> res = template.exchange(serviceUrl, HttpMethod.PUT, entity, String.class);
		System.out.println("------------------------------------------------------------------------");
		System.out.println("Response Body(result)::"+res.getBody());
		System.out.println("Response Headers::"+res.getHeaders());
		System.out.println("Response Status value::"+res.getStatusCodeValue());
